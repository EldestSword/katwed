...
The live Supabase project has applied every migration through `202608070005_quiz_backgrounds.sql`, with no pending migration. Applied files are immutable history; production changes require a new chronological forward migration.
