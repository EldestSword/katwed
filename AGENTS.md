...
- Treat the linked Supabase project and Netlify site as live production systems. Production has applied migrations through `20260828074030_multi_variant_sound_packs.sql`; later committed migrations may be awaiting a deliberate release.
