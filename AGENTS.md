...
- Treat the linked Supabase project and Netlify site as live production systems. Production has applied migrations through `202608070005_quiz_backgrounds.sql`; later committed migrations may be awaiting a deliberate release.
