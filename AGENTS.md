...
- Treat the linked Supabase project and Netlify site as live production systems. Production has applied migrations through `202608070007_head_to_head_live_play.sql`; later committed migrations may be awaiting a deliberate release.
