...
- Treat the linked Supabase project and Netlify site as live production systems. Production has applied migrations through `202608060001_fix_pgcrypto_schema.sql`; later committed migrations may be awaiting a deliberate release.
