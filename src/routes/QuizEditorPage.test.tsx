...
describe('QuizEditorPage quiz appearance', () => {
  ...
  it('shows all 51 themes and marks the persisted theme without relying on colour alone', async () => {
    ...
    expect(themes.querySelectorAll('.quiz-theme-option')).toHaveLength(51)
