...
export function TeamSetup({ settings, onChange, teamsDisabledReason }: { settings: LaunchGameSettings; onChange(settings: LaunchGameSettings): void; teamsDisabledReason?: string }) {
